<section class="cover">
    <div class="container cont-fcs produk">
        <div class="cover-image">
            <img class="w-100 d-block" src="<?php echo $this->assetBaseurl; ?>cover-produk_03<?php echo $i ?>.jpg" alt="">
            <div class="centered">
              <p>
                <?php echo strtoupper( Tt::t('front', 'Calcium Carbonate Products') ); ?>
              </p>
            </div>
        </div>
        <div class="row pt-3">
            ...
            <div class="breadcrumb">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="#"><?php echo strtoupper( Tt::t('front', 'Calcium Carbonate Products') ); ?></a></li>
                </ol>
              </nav>
            </div>
          </div>
